  ...
  return (
    <section className="container mt-10 flex flex-col items-center gap-3 text-center md:absolute md:left-1/2 md:top-1/2 md:mt-0 md:-translate-x-1/2 md:-translate-y-1/2">
      <h1 className="mb-1 font-mono text-3xl font-extrabold leading-tight tracking-tighter md:text-4xl">
        Food Donation Application Powered by GPT
      </h1>
      <p className="text-muted-foreground max-w-2xl">
        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Animi
        similique tempore assumenda laborum eum, iure error, a beatae in quia
        blanditiis. Temporibus ex officia impedit sunt iste quasi deleniti
        natus, a dolore magni, illo eveniet rerum quos itaque repudiandae
        distinctio sit fugiat deserunt! Ipsa inventore, ex vitae laudantium fuga
        soluta.
      </p>
      <div className="mt-1">
        <HeroForm />
